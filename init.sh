...
# NOTE The database and user role must already have been created (see sql/createdb.pgsql).
...
go run *.go -createUser -username="$username" -password="$password" -email="$email"
